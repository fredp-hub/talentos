...
VALUES
  ('Priya Nair',   'priya.nair@example.com',   '512-555-0101', 'senior', 'active',
   ARRAY['Java','Spring Boot','AWS','Kubernetes','PostgreSQL'],
   110.00, CURRENT_DATE + 14, 'H1B',
   'Strong backend engineer, open to remote or Austin TX. Currently at Cognizant.'),

  ('Marcus Webb',  'marcus.webb@example.com',   '214-555-0202', 'mid',    'active',
   ARRAY['React','TypeScript','Node.js','GraphQL','Azure'],
   95.00,  CURRENT_DATE + 30, 'USC',
   'Full-stack dev, strong UI chops. Contract only.'),

  ('Aisha Okonkwo','aisha.okonkwo@example.com', '713-555-0303', 'senior', 'active',
   ARRAY['Salesforce','Apex','LWC','MuleSoft','SOQL'],
   125.00, CURRENT_DATE + 7,  'GC',
   'Certified Salesforce Architect. Available for immediate start.'),

  ('Devon Larson', 'devon.larson@example.com',  '469-555-0404', 'lead',   'active',
   ARRAY['Python','Machine Learning','TensorFlow','Spark','Databricks','SQL'],
   140.00, CURRENT_DATE + 45, 'USC',
   'Data/ML lead. Wrapping up 12-month fintech engagement.'),

  ('Sonia Patel',  'sonia.patel@example.com',   '832-555-0505', 'mid',    'active',
   ARRAY['ServiceNow','ITSM','JavaScript','REST APIs','Agile'],
   88.00,  CURRENT_DATE + 10, 'EAD',
   'ServiceNow developer, 4 years experience. ITIL certified.')
...
VALUES
  ('IL-2024-001', 'Senior Java Backend Engineer', 'Hubvia', 'Capital One',
   'McLean, VA (Remote)', CURRENT_DATE + 21, '12 months', 115.00,
   'Seeking a Senior Java Backend Engineer for a high-throughput payment processing team.
...
Daily stand-ups with Capital One engineering stakeholders. Strong communication required.', 'open'),

  ('IL-2024-002', 'Salesforce Technical Architect', 'Hubvia', 'Nationwide Insurance',
   'Columbus, OH (Hybrid 2 days/week)', CURRENT_DATE + 14, '6 months', 130.00,
   'Nationwide Insurance is modernizing their Salesforce platform. Needs a seasoned Technical Architect.

Required Skills:
- Salesforce Certified Application Architect or System Architect
- Apex, Lightning Web Components, SOQL
- MuleSoft or integration middleware
- Large-scale Salesforce orgs (1000+ users)
- Salesforce governance and limits

Nice to Have:
- Insurance industry experience
- Salesforce CPQ or Field Service
- Salesforce DX, Copado

Client-facing role. Leads weekly architecture review with Nationwide IT leadership.', 'open'),

  ('IL-2024-003', 'Data Engineer / ML Platform', 'Hubvia', 'H-E-B Digital',
   'San Antonio, TX (Onsite)', CURRENT_DATE + 30, '12 months', 135.00,
   'H-E-B Digital building a real-time ML platform for personalization and supply chain.

Required Skills:
- Python (pandas, numpy, scikit-learn)
- Apache Spark and Databricks
- ML pipeline experience (MLflow, Kubeflow or similar)
- SQL and data warehouse (dbt, Snowflake or BigQuery)
...
Must work onsite in San Antonio 5 days/week.', 'open')
